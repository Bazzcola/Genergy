        ...
        <div className="profile-edit-material">
            <div className="edit-material">
                <Form onFinish={onFinish}>
                    ...
                    <Form.Item className="material-container"  key={item.value} name={['materials', `${item.value}`]}>
                    ...
                    <Form.Item className="inventory-container" key={item.value} name={['materials', `${item.value}`]}>
