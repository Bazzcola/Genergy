                ...
                <div className="current-object-list__items">
                    ...
                    <div className="current-object_item" key={index}>
                        ...
                        <div className="current-object_work-detail">
                            ...
                            {item.object_work_description.map((item:any) => <div className="current-object_work-detail__description"><span>{item.work}</span> - {item.quantity}шт - {item.price}лей.</div>)}
            
                            <span>Описание материалов</span>
                            {item.object_work_material.map((item:any) => <div className="current-object_work-detail__description"><span>{item.title}</span> - {item.quantity}шт - {item.price}лей.</div>)}
